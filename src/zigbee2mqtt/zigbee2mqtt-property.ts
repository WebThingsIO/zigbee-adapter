 ...
 */
 ...
 export class Zigbee2MqttProperty<T extends PropertyValue> extends Property<T> {
   ...
   private invertBooleans?: boolean;
   ...
   setInvertBooleans(value: boolean): void {
     this.invertBooleans = value;
   }
 
   getInvertBooleans(): boolean | undefined {
     return this.invertBooleans;
   }
